# Toy bear (teddy) dataset 2200 images YOLO format electricity

# Body

Toy Bear (Teddy) Dataset, 2200 images in YOLO format， clear images, complete annotations, suitable for target detection model training, ready to use, saves time and effort.
